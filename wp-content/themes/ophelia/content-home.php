		...
		<div class="container">
			<div class="gutter">
				<div class="owl-carousel theme-carousel">
					<?php if(get_theme_mod('slider_title_1',__( 'Добро пожаловать на наш сайт', "ophelia"))) { ?>
					<div class="item">
						<article class="article-carousel">
							<div class="article-text">
								<?php if(get_theme_mod('slider_title_1',__( 'Добро пожаловать на наш сайт', "ophelia"))) { ?><h2><?php echo esc_html(get_theme_mod('slider_title_1',__( 'Добро пожаловать на наш сайт', "ophelia"))); ?></h2><?php } ?>
								<?php if(get_theme_mod('slider_description1')) { ?><p><?php echo esc_html(get_theme_mod('slider_description1')); ?></p><?php } ?>
								<?php if(get_theme_mod('slider_button_color_text1',__( 'Read More', "ophelia"))) { ?><a href="<?php echo esc_html(get_theme_mod('slider_button_color_link1')); ?>" class="button-large-light"><?php echo esc_html(get_theme_mod('slider_button_color_text1',__( 'Читать далее', "ophelia"))); ?></a><?php } ?>
							</div>
					...
					<?php } ?>
					<?php if(get_theme_mod('slider_title_2',__( 'Добро пожаловать на наш сайт', "ophelia"))) { ?>						
					<div class="item">
						<article class="article-carousel">
							<div class="article-text">
								<?php if(get_theme_mod('slider_title_2',__( 'Добро пожаловать на наш сайт', "ophelia"))) { ?><h2><?php echo esc_html(get_theme_mod('slider_title_2',__( 'Добро пожаловать на наш сайт', "ophelia"))); ?></h2><?php } ?>
								<?php if(get_theme_mod('slider_description2')) { ?><p><?php echo esc_html(get_theme_mod('slider_description2')); ?></p><?php } ?>
								<?php if(get_theme_mod('slider_button_color_text2',__( 'Read More', "ophelia"))) { ?><a href="<?php echo esc_html(get_theme_mod('slider_button_color_link2')); ?>" class="button-large-light"><?php echo esc_html(get_theme_mod('slider_button_color_text2',__( 'Далее', "ophelia"))); ?></a><?php } ?>
							</div>
