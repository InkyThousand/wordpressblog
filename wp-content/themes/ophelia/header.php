			...
			<div class="container">
				<div class="gutter clearfix">
					...
					<?php } else if (get_theme_mod('text_logo_1',__( 'Ophelia', "ophelia"))){  ?>
						<a href="<?php echo esc_url(home_url('/')); ?>"><h1 class="logo"><?php echo esc_html(get_theme_mod('text_logo_1','INKY')); ?><span class="gray"><?php echo esc_html(get_theme_mod('text_logo_2',__( 'DAY', "ophelia"))); ?></span></h1></a>
					<?php } else {  ?>
